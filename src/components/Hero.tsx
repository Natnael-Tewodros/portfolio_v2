...
<div className="flex-1 text-center md:text-left bg-white/80 dark:bg-gray-900/80 rounded-xl px-8 py-10 shadow-xl flex flex-col justify-center items-center md:items-start">
  <span className="inline-block text-2xl md:text-3xl font-bold text-blue-600 dark:text-blue-400 mb-3">👋 Hello, I'm</span>
  ...
  <div className="flex flex-row gap-6 justify-center md:justify-start mb-2">
    <a href="mailto:natnaeltewodros@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email" className="hover:text-blue-500 text-gray-500 dark:text-gray-400 text-2xl">
      <Mail />
    </a>
    <a href="https://github.com/natnaeltewodros" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-blue-500 text-gray-500 dark:text-gray-400 text-2xl">
      <Github />
    </a>
    <a href="https://linkedin.com/in/natnaeltewodros" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-blue-500 text-gray-500 dark:text-gray-400 text-2xl">
      <Linkedin />
    </a>
  </div> {/* End Social Icons */}
</div> {/* End Hero Text Content */}
      </div> {/* End Flex Row */}
    </div> {/* End Container */}
  </section>
  );
